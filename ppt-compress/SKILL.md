...
```bash
python3 ~/compress.py <pptx_file_path> [output_directory]
```
...
python3 ~/compress.py "/path/to/file.pptx"

# Specify output directory
python3 ~/compress.py "/path/to/file.pptx" "C:\Users\ken.liu\Downloads\compressed"
```
